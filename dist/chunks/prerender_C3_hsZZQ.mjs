...
import { useSSRContext, defineComponent, mergeProps, ref, onBeforeMount, withCtx, createVNode, toDisplayString, createTextVNode, openBlock, createBlock, Fragment as Fragment$1, renderList, withAsyncContext, watch, resolveComponent, computed, reactive, resolveDynamicComponent } from 'vue';
/* empty css                          */
...
const ViewAllCategories = /*#__PURE__*/_export_sfc(_sfc_main$i, [['ssrRender',_sfc_ssrRender$i]]);
...
const ButtonComponent = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["ssrRender", _sfc_ssrRender$h], ["__scopeId", "data-v-442194c8"]]);
...
const ShowAllProductsCategory = /*#__PURE__*/_export_sfc(_sfc_main$g, [['ssrRender',_sfc_ssrRender$g]]);
...
const ShowProductsInCategory = /*#__PURE__*/_export_sfc(_sfc_main$f, [['ssrRender',_sfc_ssrRender$f]]);

async function fetchAxios(params) {
  Object.assign({"PUBLIC_GRAPHQL_URL": "https://yiiwp.local/wordpress/graphql", "PUBLIC_GRAPHQL_URL_NM": "http://crater.local/graphql", "PUBLIC_PLACEHOLDER_SMALL_IMAGE_URL": "https://via.placeholder.com/500", "PUBLIC_CURRENCY": "NOK", "PUBLIC_CURRENCY_LOCALE": "nb-NO", "PUBLIC_ALGOLIA_INDEX_NAME": "change me", "BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": undefined, "ASSETS_PREFIX": undefined}, { OS: process.env.OS, PUBLIC: process.env.PUBLIC });
...
const BaseButton = /*#__PURE__*/_export_sfc(_sfc_main$b, [['ssrRender',_sfc_ssrRender$b]]);
...
const Checkout = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["ssrRender", _sfc_ssrRender$a]]);
...
const { data } = (
  ([__temp,__restore] = withAsyncContext(() => client.query({
  query: gql`
    query Product($id: ID!) {
...
const __returned__ = { props, variables, data, ref, watch, get gql() { return gql }, get client() { return client }, get filteredVariantPrice() { return filteredVariantPrice }, get stripHTML() { return stripHTML } };
Object.defineProperty(__returned__, '__isScriptSetup', { enumerable: false, value: true });
return __returned__
}
...
function _sfc_ssrRender$9(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_CommonButton = resolveComponent("CommonButton");
  ...
  if ($props.product) {
    ...
    _push(`<br><p class="pt-1 mt-4 text-2xl text-gray-900">${ssrInterpolate($props.product.description)}</p>`);
    ...
    if ($props.product.variations) {
      _push(ssrRenderComponent(_component_AddToCartButton, {
        product: _ctx.selectedVariation,
        "client:visible": ""
      }, null, _parent));
    } else {
      _push(`<!---->`);
    ...
    _push(ssrRenderComponent(_component_CommonButton, {
      onCommonButtonClick: $event => (_ctx.addProductToCart($props.product)),
