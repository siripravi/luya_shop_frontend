...
import 'kleur/colors';
import { $ as $$Layout } from './pages/currencies_6r0LrhX1.mjs';
...
import { ssrRenderAttrs, ssrRenderList, ssrRenderAttr, ssrInterpolate, ssrRenderSlot, ssrRenderComponent, ssrRenderClass, ssrIncludeBooleanAttr, ssrRenderVNode } from 'vue/server-renderer';
import { useSSRContext, defineComponent, mergeProps, ref, onBeforeMount, withCtx, createVNode, toDisplayString, createTextVNode, openBlock, createBlock, Fragment as Fragment$1, renderList, reactive, onMounted, computed, resolveComponent, resolveDynamicComponent } from 'vue';
/* empty css                          */
/* empty css                            */
...
const AddToCartButton = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["ssrRender", _sfc_ssrRender$a], ["__scopeId", "data-v-6f1eff71"]]);
...
function _sfc_ssrRender$6(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<section${ssrRenderAttrs(mergeProps({ class: "mt-100" }, _attrs))}><div id="product-container" class="container"><!--[-->`);
  ssrRenderList($props.allProducts, (product) => {
    _push(`<div class="flex flex-col mt-6 sm:w-1/2 md:w-1/3 lg:w-1/4 lg:mr-4"><a class="text-black cursor-pointer hover:underline"${ssrRenderAttr("href", `/products/${product.slug}`)}>`);
    _push(ssrRenderComponent($setup["ProductImage"], {
      alt: product.name,
      src: $setup.productImage(product)
    }, null, _parent));
    _push(`<div class="flex justify-center pt-3"><p class="text-2xl font-bold text-center cursor-pointer">${ssrInterpolate(product.name)}</p></div></a>`);
...
const $$Products = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Products" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="mt-100"> <h1 class="text-3xl text-center font-bold p-6">Products page</h1> ${renderComponent($$result2, "ShowAllProducts", ShowAllProducts, { "allProducts": products, "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/gitrepos/luya_shop_admin/luya_shop_frontend/src/components/Products/ShowAllProducts.vue", "client:component-export": "default" })} <p>The remark and rehype pipelines only run when your content is rendered, which explains why remarkPluginFrontmatter is only available after you call render() on your content entry. In contrast, getCollection() and getEntry() cannot return these values directly because they do not render your content.</p> </section> ` })}`;
